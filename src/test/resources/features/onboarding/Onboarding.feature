Feature: Onboarding flow
  ...
  @onboarding @smoke @pendiente @MTR-1844 @MTR
...
#    And I complete the field Phone Number
  ...
  @onboarding @smoke  @MTR-1094 @MTR @MTR
