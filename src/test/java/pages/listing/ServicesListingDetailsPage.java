...
public class ServicesListingDetailsPage extends BasePage {


    public ServicesListingDetailsPage() {
        super();
    }
    ...
    @FindBy(how = How.CSS, using = "#check-hourly")
    public WebElement checkHourly;

    @FindBy(how = How.CSS, using = "#check-flat")
    public WebElement checkFlatButton;
    ...
    public void hireButton() {
        ...
        fluentWait(getDriver(), checkFlatButton);
        waitForWebElementAndClick(checkFlatButton);
