...
public String validateSaveButton(){
    ...
    public void customizeMenu() {
        //designSection();
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Menu/Customize");
        fluentWait(getDriver(), customizeMenuOrderCheckBox);
        waitForWebElementAndClick(customizeMenuOrderCheckBox);
    }

    public void customizeLogIn() {
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/application/LoginCustomize");
    ...
    public void customizeSignUp() {
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/application/SignupCustomize");
    ...
    public void customizeContactUs() {
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/application/ContactUsCustomize");
    ...
    public void customizeAboutUs() {
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/AboutUs/Index");
    ...
    public void customizeFAQ() {
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/application/FAQCustomize");
    ...
    public void customizeTermsAndConditions() {
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/application/TermsOfUseCustomize");
    ...
    public void customizePrivacyPolicy() {
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/application/PrivacyCustomize");
...
//        waitForWebElementAndClick(siteWordingBtn);
    ...
    public void settingsCompanyInfo() {
        settings();
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/admin/application/companyinfo");
...
//        waitForWebElementAndClick(settingsCompanyInfoBtn);
    ...
    public void settingsOrdersSetup() {
        settings();
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/admin/application/OrdersSetup");
    ...
    public void settingsRequestSetup() {
        settings();
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/admin/application/RequestsSetup");
...
//        waitForWebElementAndClick(settingsRequestSetupBtn);
    ...
    public void settingsDiscount() {
        ...
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/admin/application/BrowseConfig");
...
//        waitForWebElementAndClick(settingsDiscountBtn);
    ...
    public void userReviews() {
        //   reports();
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/Application/UserReviews");
...
//        waitForWebElementAndClick(userReviewsBtn);
    ...
    public void listingReviews() {
        //reports();
        getDriver().navigate().to("https://mtreborn-automation-products.azurewebsites.net/Admin/Application/ListingsReviews");
