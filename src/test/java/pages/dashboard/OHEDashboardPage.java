...
public class OHEDashboardPage extends BasePage {

    public OHEDashboardPage() {
        super();
    }
    ...
    @FindBy(how = How.CSS, using = "#buyer > div > div:nth-child(4) > div > div > div.d-flex.justify-content-between.align-items-center.mb-2 > span:nth-child(2) > a")
    ...
    @FindBy(how = How.CSS, using = "#buyer > div > div:nth-child(5) > div > div > div.d-flex.justify-content-between.align-items-center.mb-2 > span:nth-child(2) > a")
