...
import pages.onboarding.OHEOnboardingPage;


public class OHEOnboardingSteps extends BasePage {

    private OHEOnboardingPage _page;

    public OHEOnboardingSteps() {

        this._page = new OHEOnboardingPage();
    }
