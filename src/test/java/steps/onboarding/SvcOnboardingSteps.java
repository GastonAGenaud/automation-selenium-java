...
import pages.onboarding.SvcOnboardingPage;


public class SvcOnboardingSteps extends BasePage {

    private SvcOnboardingPage _page;

    public SvcOnboardingSteps() {

        this._page = new SvcOnboardingPage();
    }
