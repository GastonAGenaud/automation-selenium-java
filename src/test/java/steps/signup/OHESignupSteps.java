...
import pages.signup.OHESignupPage;

public class OHESignupSteps extends BasePage {

    private OHESignupPage _page;

    public OHESignupSteps() {

        this._page = new OHESignupPage();
    }
