...
import pages.storefront.OHEStorefrontPage;

public class OHEStorefrontSteps extends BasePage {

    private OHEStorefrontPage _page;

    public OHEStorefrontSteps() {

        this._page = new OHEStorefrontPage();
    }
