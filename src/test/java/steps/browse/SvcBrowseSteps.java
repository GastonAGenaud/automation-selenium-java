...
import pages.browse.SvcBrowsePage;


public class SvcBrowseSteps extends BasePage {

    private SvcBrowsePage _page;

    public SvcBrowseSteps() {

        this._page = new SvcBrowsePage();
