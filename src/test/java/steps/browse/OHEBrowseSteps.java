...
import pages.browse.OHEBrowsePage;


public class OHEBrowseSteps extends BasePage {

    private OHEBrowsePage _page;

    public OHEBrowseSteps() {

        this._page = new OHEBrowsePage();
