...
import pages.checkout.OHECheckoutPage;

public class OHECheckoutSteps extends BasePage {

    private OHECheckoutPage _page;

    public OHECheckoutSteps() {

        this._page = new OHECheckoutPage();
    }
