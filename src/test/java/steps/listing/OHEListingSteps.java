...
import pages.listing.OHEListingPage;

public class OHEListingSteps extends BasePage {

    private OHEListingPage _page;

    public OHEListingSteps() {

        this._page = new OHEListingPage();
    }
