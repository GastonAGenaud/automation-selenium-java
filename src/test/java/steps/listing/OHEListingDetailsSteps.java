...
import pages.listing.OHEListingDetailsPage;


public class OHEListingDetailsSteps extends BasePage {

    private OHEListingDetailsPage _page;

    public OHEListingDetailsSteps() {

        this._page = new OHEListingDetailsPage();
    }
