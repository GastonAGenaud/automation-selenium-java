...
import pages.listing.SvcListingDetailsPage;


public class SvcListingDetailsSteps extends BasePage {

    private SvcListingDetailsPage _page;

    public SvcListingDetailsSteps() {
