...
import pages.request.OHERequestPage;

public class OHERequestSteps extends BasePage {

    private OHERequestPage _page;

    public OHERequestSteps() {

        this._page = new OHERequestPage();
    }
