...
import pages.request.SvcRequestPage;

public class SvcRequestSteps extends BasePage {

    private SvcRequestPage _page;

    public SvcRequestSteps() {

        this._page = new SvcRequestPage();
    }
