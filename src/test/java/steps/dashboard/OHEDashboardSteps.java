...
import pages.dashboard.OHEDashboardPage;

import java.io.IOException;

public class OHEDashboardSteps extends BasePage {

    public OHEDashboardPage _page;

    public OHEDashboardSteps() {

        this._page = new OHEDashboardPage();
    }
