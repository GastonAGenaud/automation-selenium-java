...
import pages.bookings.OHEBookingsPage;


public class OHEBookingsSteps extends BasePage {

    private OHEBookingsPage _page;

    public OHEBookingsSteps() {

        this._page = new OHEBookingsPage();
